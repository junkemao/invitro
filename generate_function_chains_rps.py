...
def generate_csv_files(rps, output_dir="data/traces/example2"):
    # Create output directory if it doesn't exist
    output_dir = os.path.join("data/traces/example2", f"{rps}")
    ...
    row_data = ["c455703077a17a9b8d0fc655d939fcc6d24d819fa9a1066b74f710c35a43cbc8","68baea05aa0c3619b6feb78c80a07e27e4e68f921d714b8125f916c3b3370bf2","c13acdc7567b225971cef2416a3a2b03c8a4d8d154df48afe75834e2f5c59ddf","1",20,20,20,20,20,20,20,20,20,20]
    ...
    header3 = ["HashOwner","HashApp","HashFunction","Trigger","1",f"{rps}","3","4",f"{rps}","6","7","8","9","10"]
    rps = rps*60
    row_data = ["c455703077a17a9b8d0fc655d939fcc6d24d819fa9a1066b74f710c35a43cbc8","68baea05aa0c3619b6feb78c80a07e27e4e68f921d714b8125f916c3b3370bf2","c13acdc7567b225971cef2416a3a2b03c8a4d8d154df48afe75834e2f5c59ddf","queue",f"{rps}",f"{rps}",f"{rps}",f"{rps}",f"{rps}",f"{rps}",f"{rps}",f"{rps}",f"{rps}",f"{rps}"]
...
parser = argparse.ArgumentParser(description="Add one number.")
parser.add_argument('rps', type=int)

args = parser.parse_args()
generate_csv_files(args.rps)